...
import { companySettingsRouter } from "./api/routers/companySettings";
...
export const appRouter = router({
  ...
  companySettings: companySettingsRouter, // Refactored to server/api/routers/companySettings.ts
