...
const SidebarItem: React.FC<SidebarItemProps> = ({ icon: Icon, label, active = false }) => (
  ...
  >
    <Icon size={20} className={active ? 'text-cyan-400' : 'text-gray-500 group-hover:text-white'} />
...
export default function OwnerFinanceDashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-[#0B0C10] text-gray-100 font-sans selection:bg-cyan-500/30">
      ...
      {/* Sidebar Navigation */}
      <aside className={`${isSidebarOpen ? 'w-64' : 'w-20'} hidden md:flex flex-col border-r border-gray-800 bg-[#0B0C10] transition-all duration-300 relative z-20`}>
        {/* Logo Area */}
        ...
        <nav className="flex-1 px-3 py-6 space-y-2">
          ...
          <SidebarItem icon={Briefcase} label="Jobs & Estimates" />
        ...
        <div className="p-4 border-t border-gray-800/50">
          <div className={`flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-gray-800 to-gray-900 border border-gray-700 ${!isSidebarOpen && 'justify-center'}`}>
